...
export class init1683673953903 implements MigrationInterface {
    name = 'init1683673953903'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "room" ("id" SERIAL NOT NULL, "price" integer NOT NULL, "description" character varying NOT NULL, "name" character varying NOT NULL, "maxGuests" integer NOT NULL, CONSTRAINT "PK_c6d46db005d623e691b2fbcba23" PRIMARY KEY ("id"))`);
